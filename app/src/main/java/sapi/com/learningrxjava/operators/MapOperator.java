...
/**
 * RxJava Doc - Map operator, transform the item emitted by an observable by applying a function to each item.
 *
 * In this case our observable emits student objects. We can write a function to transform each of those student
 * objects.
 *
 * What is the difference between create() and map() operator ?
 * In create() we can transform the data before emission and in map() we can
 * transform the data after emission.
 */
